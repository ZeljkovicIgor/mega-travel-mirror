...
@XmlRootElement(name = "editOneAccommodationResponse", namespace = "http://megatravel.com/booking/ws")
public class EditOneAccommodationResponse {

    @XmlElement(name = "accDB_id", namespace = "http://megatravel.com/booking/ws")
