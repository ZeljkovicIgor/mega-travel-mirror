...
@XmlRootElement(name = "sendReservationResponse", namespace = "http://megatravel.com/booking/ws")
public class SendReservationResponse {

    @XmlElement(name = "reservation_id", namespace = "http://megatravel.com/booking/ws")
    protected long reservationId;
    @XmlElement(name = "reservation_price", namespace = "http://megatravel.com/booking/ws")
